...
public class SubGuiNpcMovement extends SubGuiInterface implements ITextfieldListener {
   ...
   public void initGui() {
      ...
      if (this.ai.getMovingType() == 1) {
         int var10005 = this.guiLeft + 100;
         int var3 = y + 22;
         this.addTextField(new GuiNpcTextField(4, this, var10005, var3, 40, 20, this.ai.walkingRange + ""));
         this.getTextField(4).numbersOnly = true;
         this.getTextField(4).setMinMaxDefault(0, 1000, 10);
         this.addLabel(new GuiNpcLabel(4, "gui.range", this.guiLeft + 4, var3 + 5));
         var10004 = this.guiLeft + 100;
         int var4 = var3 + 22;
         this.addButton(new GuiNpcButton(5, var10004, var4, 50, 20, new String[]{"gui.no", "gui.yes"}, this.ai.npcInteracting ? 1 : 0));
         this.addLabel(new GuiNpcLabel(5, "movement.wanderinteract", this.guiLeft + 4, var4 + 5));
         ...
         int var18 = this.guiLeft + 99;
         y = y + 22;
         this.addTextField(new GuiNpcTextField(7, this, var18, y, 24, 20, (int)this.ai.bodyOffsetX + ""));
         ...
         if (this.ai.animationType != 2) {
            ...
            var18 = this.guiLeft + 99;
            y = y + 22;
            this.addTextField(new GuiNpcTextField(5, this, var18, y, 40, 20, this.ai.orientation + ""));
      ...
      if (this.ai.getMovingType() == 2) {
         var10004 = this.guiLeft + 80;
         int var7 = y + 22;
         this.addButton(new GuiNpcButton(8, var10004, var7, 80, 20, new String[]{"ai.looping", "ai.backtracking"}, this.ai.movingPattern));
         this.addLabel(new GuiNpcLabel(8, "movement.name", this.guiLeft + 4, var7 + 5));
         var10004 = this.guiLeft + 80;
         y = var7 + 22;
         this.addButton(new GuiNpcButton(9, var10004, y, 80, 20, new String[]{"gui.no", "gui.yes"}, this.ai.movingPause ? 1 : 0));
         this.addLabel(new GuiNpcLabel(9, "movement.pauses", this.guiLeft + 4, y + 5));
      ...
      int var20 = this.guiLeft + 80;
      y = y + 22;
      this.addTextField(new GuiNpcTextField(14, this, var20, y, 50, 18, this.ai.getWalkingSpeed() + ""));
