...
public class GuiNpcHealer extends GuiNPCInterface2 {
   ...
   public GuiNpcHealer(EntityNPCInterface npc) {
      ...
      for(Potion p : Potion.REGISTRY) {
         this.potions.put(p.getName(), Integer.valueOf(Potion.getIdFromPotion(p)));
      }
   ...
   protected void actionPerformed(GuiButton guibutton) {
      ...
      if (button.id == 13) {
         ...
         for(Potion p : Potion.REGISTRY) {
            this.job.effects.put(Integer.valueOf(Potion.getIdFromPotion(p)), Integer.valueOf(this.potency));
         }
