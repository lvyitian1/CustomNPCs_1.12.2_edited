...
public class GuiNpcFollowerSetup extends GuiContainerNPCInterface2 {
   ...
   public void initGui() {
      ...
      for(int i = 0; i < 3; ++i) {
         ...
         y = y + i * 25;
         GuiNpcTextField tf = new GuiNpcTextField(i, this, this.fontRenderer, x, y, 24, 20, "1");
         tf.numbersOnly = true;
      ...
      for(Iterator var6 = this.role.rates.values().iterator(); var6.hasNext(); ++i) {
         int day = ((Integer)var6.next()).intValue();
