...
public class RenderProjectile extends Render {
   ...
   public void doRenderProjectile(EntityProjectile par1EntityProjectile, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      float scale = (float)par1EntityProjectile.getSize() / 10.0F;
      ...
      if (par1EntityProjectile.isArrow()) {
         ...
         float f8 = 0.05625F;
         GlStateManager.enableRescaleNormal();
         float f9 = (float)par1EntityProjectile.arrowShake - partialTicks;
         if (f9 > 0.0F) {
         ...
         if (this.renderOutlines) {
            ...
            GlStateManager.enableOutlineMode(this.getTeamColor(par1EntityProjectile));
         }
