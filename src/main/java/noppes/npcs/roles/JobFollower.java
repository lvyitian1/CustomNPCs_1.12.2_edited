   ...
   public boolean aiShouldExecute() {
      if (this.npc.isAttacking()) {
         ...
         if (this.ticks > 0) {
            ...
            for(EntityNPCInterface entity : this.npc.world.getEntitiesWithinAABB(EntityNPCInterface.class, this.npc.getEntityBoundingBox().grow((double)this.getRange(), (double)this.getRange(), (double)this.getRange()))) {
