...
public interface ICustomNpc<T extends EntityCreature> extends IEntityLiving<T> {
   ...
   IEntityProjectile shootItem(IEntityLivingBase var1, IItemStack var2, int var3);

   IEntityProjectile shootItem(double var1, double var3, double var5, IItemStack var7, int var8);
