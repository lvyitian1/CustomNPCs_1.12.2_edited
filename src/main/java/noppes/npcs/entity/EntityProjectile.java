...
public class EntityProjectile extends EntityThrowable {
   ...
   public EntityProjectile(World par1World, EntityLivingBase par2EntityLiving, ItemStack item, boolean isNPC) {
      ...
      this.dataManager.set(Arrow, Boolean.valueOf(this.getItem() == Items.ARROW));
   ...
   public void onUpdate() {
      ...
      if (this.inGround) {
         ...
         if (movingobjectposition != null) {
            if (movingobjectposition.typeOfHit == Type.BLOCK && this.world.getBlockState(movingobjectposition.getBlockPos()).getBlock() == Blocks.PORTAL) {
         ...
         for(this.rotationPitch = (float)(Math.atan2(this.motionY, (double)f1) * 180.0D / 3.141592653589793D); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
            ;
         }
         ...
         if (this.world.isRemote && ((Integer)this.dataManager.get(Particle)).intValue() > 0) {
            this.world.spawnParticle(ParticleType.getMCType(((Integer)this.dataManager.get(Particle)).intValue()), this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D, new int[0]);
         }
   ...
   protected void onImpact(RayTraceResult movingobjectposition) {
      if (!this.world.isRemote) {
         ...
         if (movingobjectposition.entityHit != null) {
            ...
            event = new ProjectileEvent$ImpactEvent((IEntityProjectile)NpcAPI.Instance().getIEntity(this), 1, NpcAPI.Instance().getIBlock(this.world, pos));
         }
      ...
      if (movingobjectposition.entityHit != null) {
         ...
         if (this.inTile != null) {
            this.inTile.onEntityCollision(this.world, this.tilePos, state, this);
         }
      }
      ...
      if (this.explosiveRadius > 0) {
         ...
         if (this.effect != 0) {
            ...
            for(EntityLivingBase entity : this.world.getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb)) {
               if (this.effect != 1) {
                  Potion p = PotionEffectType.getMCType(this.effect);
                  if (p != null) {
   ...
   public void getStatProperties(DataRanged stats) {
      ...
      this.dataManager.set(Size, Integer.valueOf(stats.getSize()));
      this.dataManager.set(Glows, Boolean.valueOf(stats.getGlows()));
   ...
   public float getBrightness() {
      return ((Boolean)this.dataManager.get(Glows)).booleanValue() ? 1.0F : super.getBrightness();
   }

   @SideOnly(Side.CLIENT)
   public int getBrightnessForRender() {
      return ((Boolean)this.dataManager.get(Glows)).booleanValue() ? 15728880 : super.getBrightnessForRender();
   }
   ...
   public boolean is3D() {
      return ((Boolean)this.dataManager.get(Is3d)).booleanValue() || this.isBlock();
   }

   public boolean sticksToWalls() {
      return this.is3D() && ((Boolean)this.dataManager.get(Sticks)).booleanValue();
   }
